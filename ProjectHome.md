Dez is an asynchronous network stack for Python. Its sole dependency is [Registered Event Listener](http://code.google.com/p/registeredeventlistener), which enables dez to run without libevent (a C module).
...
Latest version, 0.5.3.6: https://pypi.python.org/pypi/dez